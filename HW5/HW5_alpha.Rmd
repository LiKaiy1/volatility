...
###e) Further more, assume the joint distribution of asset values of obligor i and obligor j follow bivariate normal distribution. What is the correlation of the bivariate normal?
...
=w_iw_j
$$
##f) Let $\Phi_2$ denote the cumulative distribution function of bivariate normal distribution, set
$$
...
##2.Predict LGD with data file lgd.csv.
```{r}
