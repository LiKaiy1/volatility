...
# print(true_ivix[u'收盘价(元)'].tolist())
# print(ivix)
df = pd.DataFrame()
df['DateTime'] = tradeday['DateTime'][0:len(ivix)]
df.set_index('DateTime',inplace=True)
df['true_ivix'] = true_ivix[u'收盘价(元)'].tolist()[0:len(ivix)]
df['calculated_ivix'] = ivix
# df.plot()
df.to_csv("Calculated_IVIX.csv")
print(df.head())
